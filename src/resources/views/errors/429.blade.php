...
<head>
    ...
    <meta name="description" content="429 Too Many Requests – The user has sent too many requests in a given amount of time.">
    <meta name="keywords" content="Error page 429, too many requests, rate limit">
                ...
                <div class="content-detail">
                    <div class="pendulum-platform">
                        ...
                        <div class="pendulum-thread">
                            ...
                            <div class="pendulum">429</div>
                        </div>
                        <div class="pendulum-shadow"></div>
                    </div>
                    <div class="text-detail">
                        <h4 class="sub-title">Oops!</h4>
                        <p class="detail-text">Too Many Requests,<br>You have sent too many requests in a short period of time. Please try again later.</p>
                        <div class="back-btn">
