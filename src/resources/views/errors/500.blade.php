...
<head>
    ...
    <meta name="description" content="500 Internal Server Error – There is a problem with the server's internal configuration.">
    <meta name="keywords" content="Error page 500, internal server error, server problem">
            ...
            <div class="container-fluid">
                <div class="content-detail">
                    ...
                    <div class="text-detail">
                        ...
                        <p class="detail-text">Internal Server Error,<br> The server encountered an internal error and was unable to complete your request.</p>
                        <div class="back-btn">
